...
exports.seed = async function(knex) {
  ...
  await knex('room_listings').insert([
    {description: "room_1", photos: 'urls',price: '347', location:"Queens",user_id: 1},
    {description: "room_2", photos: 'urls',price: '566', location:"Bronx",user_id: 2},
    {description: "room_3", photos: 'urls',price: '788', location:"Brooklyn",user_id: 2},
    {description: "room_4", photos: 'urls',price: '988', location:"Manhattan",user_id: 2},
    {description: "room_5", photos: 'urls',price: '899', location:"land_lord",user_id: 1},
  ]);
